...
list_of_files = [
    ...
    f"{project_name}/config/base_config.py",
    ...
    f"{project_name}/schemas/request_schemas.py",
    f"{project_name}/schemas/response_schemas.py",
    f"{project_name}/schemas/model_schema.py",
    ...
    f"{project_name}/cloud/cloud_handler.py",
